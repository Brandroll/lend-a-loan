    ...
    <Transition show={open} as={Fragment}>
      ...
      >
        <div className="min-h-full text-center md:p-5">
          ...
          >
            <Dialog.Panel className="min-w-content bg-white px-8 rounded-lg  relative inline-block max-w-full align-middle transition-all ltr:text-left rtl:text-right">
              <button
                onClick={onClose}
