...
export default function AlternateGrid12({
  content,
}: {
  content: {
    information: {
        ...
        <>
          <section className="grid lg:grid-cols-12 gap-4   " key={i}>
            <div
              className={`${
                calc(i) === "even"
                  ? "lg:order-2 mt-4  lg:mt-0 col-span-8"
                  : " col-span-8"
            ...
            <div
              className={`${
                calc(i) === "even"
                  ? "md:order-1 lg:mr-12 col-span-4"
                  : " ml-4 col-span-4"
              }   lg:mt-0  flex`}
            >
              <div className="flex flex-col  font-isidorasans_regular justify-center  ">
                <h4
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize("Warehouse                    "),
                  }}
                  className="text-dark my-5  text-28px lg:text-36px font-isidorasans_semi_bold  font-medium md:mb-8"
                />
                <WPHTMLContent
                  html={`Whether you’re planning to expand your business by purchasing a warehouse or looking at
buying a commercial warehouse for investment purposes, we have a lot of experience in
commercial & property finance. We have a range of lenders to get you the best deal.`}
                />

                <Link legacyBehavior href={"#"}>
                  <a className="flex mb-4 hover:text-brand-blue items-center gap-4">
                    <svg
                      ...
                      strokeWidth={1}
                      stroke="currentColor"
                      className="w-16 md:w-10 h-16 md:h-10 text-brand-blue"
                    >
                      <path
                        strokeLinecap="round"
                    ...
                    <span className="hover:text-brand-blue font-isidorasans_semi_bold">
